...
За основу для обучения моделей и валидации результата был взят датасет по распознаванию текста на чеках - (https://openreview.net/pdf?id=SJl3z659UH)[OCRD].
...
2. Была дообучена модель YOLO v 5 s
